...
LABEL maintainer="Gergely Brautigam"
...
RUN apt-get -y install openjdk-11-jre wget
RUN mkdir /minecraft
...
# Create moun http://127.0.0.1:3999t point, and mark it as holding externally mounted volume
WORKDIR /data
VOLUME /data
